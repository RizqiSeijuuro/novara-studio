...
| `novara-mark-transparent.svg` | The Novara "nova" logo mark on a transparent background — a radial iris-gradient orb with an ambient halo. Used as the favicon by `index.html` and the case study pages. |
